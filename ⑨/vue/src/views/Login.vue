<template>
  <div class="login-container">
    <div class="login-box">
      <div style="font-weight: bold; font-size: 24px; text-align: center; margin-bottom: 30px; color: #0ea5e9">欢迎登录⑨号教务系统</div>
...
.login-container {
  ...
  align-items: center;
  background: radial-gradient(circle at top, #0f172a, #1e1b4b 45%, #020617);
}
.login-box {
  width: 420px;
  padding: 48px 36px;
  border-radius: 24px;
  box-shadow: 0 25px 50px rgba(15, 23, 42,.45);
