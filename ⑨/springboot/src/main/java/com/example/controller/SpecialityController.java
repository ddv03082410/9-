...
public class SpecialityController {
    ...
    @GetMapping("/selectByCollege/{collegeId}")
    public Result selectByCollege(@PathVariable Integer collegeId) {
        return Result.success(specialityService.selectByCollegeId(collegeId));
    }
}
